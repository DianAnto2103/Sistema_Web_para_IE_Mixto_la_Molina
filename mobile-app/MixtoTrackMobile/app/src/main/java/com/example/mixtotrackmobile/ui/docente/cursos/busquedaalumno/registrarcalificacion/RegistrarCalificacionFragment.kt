package com.example.mixtotrackmobile.ui.docente.cursos.busquedaalumno.registrarcalificacion
...
class RegistrarCalificacionFragment : Fragment() {

    companion object {
        fun newInstance() = RegistrarCalificacionFragment()
    }
